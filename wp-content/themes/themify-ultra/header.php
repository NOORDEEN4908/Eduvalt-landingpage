					...
					<div id="mobile-menu" class="sidemenu sidemenu-off<?php if($header_design!=='header-leftpane' && $header_design!=='header-rightpane'):?> tf_scrollbar<?php endif;?>">
						...
						<div class="navbar-wrapper tf_clearfix">
							...
							<?php if ( themify_theme_dark_mode() === 'user' ) : ?>
								<a class="tf_darkmode_toggle" href="#"><?php echo themify_get_icon( 'fas moon', 'fa' ); ?><span class="screen-reader-text"><?php _e( 'Dark mode', 'themify' ); ?></span></a>
							<?php endif; ?>
							...
							<nav id="main-nav-wrap" itemscope="itemscope" itemtype="https://schema.org/SiteNavigationElement">
								<?php if ( $show_menu_navigation ){
									themify_menu_nav( [
										...
										'post_count' => themify_check( 'setting-mega_menu_post_count',true ),
										'fallback_args' => [
											'depth' => 1
										]
									] );
